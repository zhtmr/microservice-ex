...
public class GlobalControllerExceptionHandler {
  ...
  public @ResponseBody HttpErrorInfo handleNotFoundExceptions(ServerHttpRequest request,
  ...
  private HttpErrorInfo createHttpErrorInfo(HttpStatus httpStatus, ServerHttpRequest request,
    ...
    LOG.debug("return HTTP status: {}, path: {}, message: {}", httpStatus, path, message);
